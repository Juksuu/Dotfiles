{ self, config, pkgs, makeMutableSymlink, ... }: {
  ...
  home.file = {
    # Scripts
    "scripts".source =
      config.lib.file.mkOutOfStoreSymlink "/Users/juksu/.dotfiles/scripts";
    ".config/nvim".source =
      config.lib.file.mkOutOfStoreSymlink "/Users/juksu/.dotfiles/configs/nvim";
    ".config/kitty".source = config.lib.file.mkOutOfStoreSymlink
      "/Users/juksu/.dotfiles/configs/kitty";
  };
