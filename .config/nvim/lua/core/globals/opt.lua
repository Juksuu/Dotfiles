--[[ 
  To load vim options from vim.opt.
  Source https://github.com/tjdevries/config_manager/blob/master/xdg_config/nvim/lua/tj/globals/opt.lua
--]] -- LuaFormatter off
...
-- local concat_keys = functiont, sep)
